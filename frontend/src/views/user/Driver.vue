                    ...
                    <template slot="tab-pane-1">
                        <md-card>
                            ...
                            <md-card-actions md-alignment="space-between" v-if="hasPermission(constants.PERMISSION.MANAGE_DRIVERS)">
                                ...
                                <template v-if="hasPermission(constants.PERMISSION.MANAGE_DRIVERS) && !driver.sleep && driver.status === constants.STATUS.READY && driver.location.id !== driver.garage.location.id && 1 === 0">
