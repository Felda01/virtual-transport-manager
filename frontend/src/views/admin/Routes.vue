                    ...
                    <template v-else>
                        <md-table v-model="routes.data" v-if="routes && routes.data" class="table-striped">
                            <md-table-row slot="md-table-row" slot-scope="{ item, index }">
                                ...
                                <md-table-cell :md-label="$t('route.property.distance')">{{ item.distance }}</md-table-cell>
                                <md-table-cell :md-label="$t('route.property.time')">{{ item.time }}</md-table-cell>
                                <md-table-cell :md-label="$t('route.property.fee')">{{ item.fee }}</md-table-cell>
