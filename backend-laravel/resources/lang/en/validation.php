...
return [
    ...
    */
    ...
    'trailer_assigned_truck' => "The selected trailer does not belong to the selected truck.",
    'truck_has_driver' => "The selected driver does not belong to the selected truck.",
